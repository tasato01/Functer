                                ...
                                {!((selectedObject.val as CircleConstraint).conditions?.length || (selectedObject.val as CircleConstraint).condition) ? (
                                    <button
                                        onClick={() => {
                                            ...
                                            setLevel(l => ({ ...l, shapes: l.shapes.map(s => s.id === selectedId ? { ...s, conditions: [['']] } : s) }));
                                        }}
                                        className="w-full py-1 border border-dashed border-neon-blue/50 text-neon-blue hover:bg-neon-blue/10 rounded text-[10px] flex items-center justify-center gap-1"
                                    >
                                        + Set Condition
                                    </button>
                                ) : (
                                                ...
                                                <div key={gIdx} className="bg-black/30 p-2 rounded border border-white/10">
                                                    <div className="flex justify-between items-center mb-1">
                                                        ...
                                                        <button onClick={() => {
                                                            ...
                                                            // If empty, it goes back to button?
