...
import { Play, Square, Home, List, RefreshCw, AlertTriangle, HelpCircle, Plus, Minus, ChevronRight, ChevronDown } from 'lucide-react';
...
export const PlayPage: React.FC = () => {
    ...
    useEffect(() => {
        ...
        stopGame();
        setIsLiked(false);
        setIsOverlayCollapsed(false); // Reset collapse state
